...
def local_rmsd():
	...
	path = "/Users/tarunkhanna/Documents/Bioinformatics/results/local_rmsd/overlay_images"
	...
	while k < len(gt):
		...
		try:
			...
			avg = average(list1)
			h.write("{}	{}	{}	{}	{}".format(t1,wt,mut,avg[0],avg[1]))
			h.write("\n")
			h1.write("{}	{}	{}	{}	{}	{}".format(t1,wt,mut,mutpos,avg[0],avg[1]))
			h1.write("\n")
		except:
